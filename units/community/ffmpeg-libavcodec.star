...
alpine_pkg(
    ...
    repo = "community",
    runtime_deps = ["libSvtAv1Enc", "aom-libs", "ffmpeg-libavutil", "musl", "libdav1d", "libjxl", "lame-libs", "opus", "rav1e-libs", "ffmpeg-libswresample", "libtheora", "libva", "libvorbis", "onevpl-libs", "libvpx", "libwebp", "libwebpmux", "x264-libs", "x265-libs", "xvidcore", "zlib"],
    apk_checksum = {
